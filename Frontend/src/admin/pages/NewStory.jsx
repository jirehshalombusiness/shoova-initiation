  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <section className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 md:p-8">
        ...
        <p className="text-xs text-gray-400 mt-2">
          We will upgrade this area to a rich-text editor next.
        </p>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col sm:flex-row justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl border border-gray-300 text-gray-800 font-semibold hover:bg-gray-50 transition"
          >
            <Save size={18} />
            Save Draft
          </button>
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#0f172a] text-white font-semibold hover:bg-[#1e293b] transition"
          >
            <Send size={18} />
            Publish Story
          </button>
